...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${siteUrl}/ipo-gmp-today`,
    languages: {
      "en-IN": `${siteUrl}/ipo-gmp-today`,
      "x-default": `${siteUrl}/ipo-gmp-today`,
    },
  },
  openGraph: {
...
const faqItems = [
  {
    ...
    a: "IPO GMP is the price at which IPO shares are traded informally in the grey market before the official stock exchange listing. A positive GMP means the market expects the shares to list above the issue price; a negative GMP signals expected listing below issue price.",
  },
  {
    q: "How is estimated listing price calculated from GMP?",
    a: "Estimated listing price = Issue price (upper end of price band) + GMP. For example, if an IPO has a price band of Rs 100-110 and a GMP of Rs 50, the estimated listing price is Rs 160 (a 45% listing gain).",
  },
  {
    q: "Is IPO GMP reliable for predicting listing gains?",
    a: "GMP is indicative, not guaranteed. It reflects grey-market sentiment and is often directionally correct for high-demand IPOs. However, actual listing prices can differ significantly. Always consider subscription data, financials and market conditions alongside GMP.",
  },
  {
    q: "Where can I see live GMP for all IPOs?",
    a: "IPO Desk (IPODESK) tracks live GMP for all ongoing mainboard and SME IPOs on the IPO Calendar page. Each IPO detail page shows the GMP chart and estimated listing price.",
  },
];
        ...
        <section className="relative overflow-hidden border-b border-border/40 bg-gradient-to-br from-primary/5 via-background to-background px-4 py-12 sm:py-16">
          <div className="container mx-auto max-w-4xl">
            ...
            <p className="mt-4 max-w-2xl text-base text-muted-foreground">
              ...
              See estimated listing prices, GMP percentage, and trend charts &mdash; updated daily
              on IPO Desk (IPODESK).
            </p>
          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-muted-foreground">
                IPO GMP, or Grey Market Premium, is the unofficial premium at which IPO shares trade
                in the informal grey market{" "}
                <strong className="text-foreground">before their official listing</strong> on NSE or
                BSE. The grey market is not regulated by SEBI.
              </p>
              <p className="mt-3 text-muted-foreground">
                A <strong className="text-foreground">positive GMP</strong> (e.g. Rs 80 premium on a
                Rs 400 issue) indicates the grey market expects shares to list at Rs 480 &mdash; a
                20% listing gain. A{" "}
                <strong className="text-foreground">negative or zero GMP</strong> suggests weak
                demand and potential listing below issue price.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="rounded-lg border border-border bg-card p-4">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Example: Price band Rs 300-320, GMP = Rs 50 &rarr; Estimated listing = Rs 370
                  (15.6% gain)
                </p>
              </div>
              <p className="mt-3 text-muted-foreground">
                The GMP percentage is calculated as:{" "}
                <code className="text-xs bg-muted px-1 rounded">(GMP / Cap Price) x 100</code>
              </p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-foreground mb-4">
                Where to Track Live IPO GMP
              </h2>
              <p className="text-muted-foreground">
            ...
            <section>
              ...
              <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  GMP is <strong className="text-foreground">indicative only</strong> and not a
                  guarantee of listing performance. It reflects grey-market sentiment which may not
                  align with actual market conditions on listing day. Do not make investment
                  decisions based solely on GMP.
                </p>
              </div>
            </section>
            ...
            <section className="rounded-xl border border-primary/20 bg-primary/5 p-6 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                All current IPOs with live GMP and estimated listing prices &mdash; updated daily.
              </p>
              <Link
                href="/calendar"
      ...
      <footer className="border-t border-border py-3">
        <div className="container mx-auto px-4 text-center">
          <p className="text-[10px] text-muted-foreground">
            &copy; 2026 IPO Desk (IPODESK) &mdash; GMP figures are indicative, not investment
            advice.
          </p>
        </div>
      </footer>
