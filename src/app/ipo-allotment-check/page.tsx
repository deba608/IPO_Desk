...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      "en-IN": `${siteUrl}/ipo-allotment-check`,
      "x-default": `${siteUrl}/ipo-allotment-check`,
    },
  },
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "IPO Allotment Check -- IPO Desk",
      },
    ],
  },
  twitter: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Home", item: siteUrl },
    {
      "@type": "ListItem",
      position: 2,
      name: "IPO Allotment Check",
      item: `${siteUrl}/ipo-allotment-check`,
    },
  ],
};
...
const faqItems = [
  {
    ...
    a: "Visit IPO Desk (IPODESK), enter your PAN number and select the IPO. The checker queries the registrar in real time and shows your allotment result instantly -- no login required.",
  },
  {
    q: "When is the IPO allotment date?",
    a: "IPO allotment is typically finalised 6 days after the issue closes. The exact allotment date is listed on the IPO Calendar on IPO Desk for every current IPO.",
  },
  {
    q: "Can I check allotment for multiple PANs at once?",
    a: "Yes. IPO Desk supports bulk PAN checking -- upload an Excel file with multiple PAN numbers and get allotment results for all applicants in one go.",
  },
  {
  ...
  },
  {
    ...
    a: "If you are not allotted shares, the blocked amount in your bank account is unblocked via ASBA/UPI mandate reversal within 1-2 business days after the allotment date.",
  },
];
          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-muted-foreground">
                After an IPO closes, the registrar finalises the basis of allotment within 6
                business days. You can check whether you received shares using your PAN number.
              </p>
              <ol className="mt-4 space-y-3 list-decimal list-inside text-muted-foreground">
                ...
                <li>
                  Click <strong className="text-foreground">Check Status</strong> &mdash; results
            ...
            <section>
              <h2 className="text-xl font-bold text-foreground mb-4">
                How IPO Allotment Works (SEBI Rules)
              </h2>
              <p className="text-muted-foreground">
                Indian IPOs use the ASBA (Application Supported by Blocked Amount) mechanism. Your
                bank blocks the application money until allotment. Under SEBI guidelines for the
                retail category:
              </p>
              <ul className="mt-4 space-y-2 list-disc list-inside text-muted-foreground">
                <li>
                  If the retail portion is undersubscribed, all applicants receive their full lot
                  quantity.
                </li>
                <li>
                  If oversubscribed, allotment is done via a computerised lottery &mdash; each
                  unique PAN gets one entry regardless of lot count applied.
                </li>
                <li>Applying for more lots with the same PAN does NOT improve your odds.</li>
                <li>
                  Unallotted amounts are unblocked within 1-2 business days after the allotment
                  date.
                </li>
              </ul>
            </section>
      ...
      <footer className="border-t border-border py-3">
        <div className="container mx-auto px-4 text-center">
          <p className="text-[10px] text-muted-foreground">
            &copy; 2026 IPO Desk (IPODESK) &mdash; Allotment data sourced from official registrar
            systems.
          </p>
        </div>
      </footer>
