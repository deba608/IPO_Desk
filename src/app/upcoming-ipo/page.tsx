...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      "en-IN": `${siteUrl}/upcoming-ipo`,
      "x-default": `${siteUrl}/upcoming-ipo`,
    },
  },
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Upcoming IPO India 2026 -- IPO Desk",
      },
    ],
  },
  twitter: {
...
const HOW_TO_APPLY = [
  {
    step: "1",
    title: "Track the Opening Date",
    desc: "Save the IPO opening date from the calendar. Set a reminder 1 day before.",
  },
  {
    step: "2",
    title: "Check Price Band & Lot Size",
    desc: "Calculate minimum investment: Lot size x Cap price. Ensure you have funds ready.",
  },
  {
    step: "3",
    title: "Apply via Your Broker",
    desc: "Use your stock broker's app (Zerodha, Groww, Upstox, HDFC Securities, etc.) to apply on day 1.",
  },
  {
    step: "4",
    title: "Approve UPI Mandate",
    desc: "Approve the UPI payment mandate in your bank app within 24 hours of application.",
  },
  {
    step: "5",
    title: "Track with Family Checklist",
    desc: "Use IPO Desk's Family Checklist to track applications across multiple PANs.",
  },
  {
    step: "6",
    title: "Check Allotment",
    desc: "Once allotment is finalised, check your PAN status instantly on IPO Desk.",
  },
];

export default async function UpcomingIpoPage() {
  type IpoItem = Awaited<ReturnType<typeof getCalendar>>["ipos"][number];
  let upcomingIpos: IpoItem[] = [];
  let openIpos: IpoItem[] = [];
        ...
        <section className="relative overflow-hidden border-b border-border/40 bg-gradient-to-br from-primary/5 via-background to-background px-4 py-12 sm:py-16">
          <div className="container mx-auto max-w-5xl">
            ...
            <p className="mt-4 max-w-2xl text-base text-muted-foreground">
              ...
              bands, lot sizes, issue sizes, GMP and subscription status &mdash; all in one place on
              IPO Desk (IPODESK).
            </p>
          ...
          {openIpos.length > 0 && (
            <section>
              <h2 className="text-xl font-bold text-foreground mb-1">
                IPOs Open for Subscription Now
              </h2>
              <p className="text-sm text-muted-foreground mb-5">
                These IPOs are currently accepting applications. Apply via your broker before the
                close date.
              </p>
                    ...
                    {openIpos.map((ipo) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-muted-foreground">
                          {formatBand(ipo.priceBand)}
                        </td>
                        <td className="px-4 py-3 text-muted-foreground">
                          {ipo.lotSize} shares
                        </td>
                        <td className="px-4 py-3 text-muted-foreground">
                          {formatCr(ipo.issueSizeCr)}
                        </td>
          ...
          {openIpos.length === 0 && upcomingIpos.length === 0 && (
            <div className="rounded-lg border border-border bg-card p-8 text-center">
              <p className="text-muted-foreground">
                No upcoming IPOs found at this time. Check back soon or visit the{" "}
      ...
      <footer className="border-t border-border py-3">
        <div className="container mx-auto px-4 text-center">
          <p className="text-[10px] text-muted-foreground">
            &copy; 2026 IPO Desk (IPODESK) &mdash; IPO data is for informational purposes only, not
            investment advice.
          </p>
        </div>
      </footer>
